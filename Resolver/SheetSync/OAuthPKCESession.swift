...
extension OAuthPKCESession {
    ...
    static func shared(for kind: SheetSyncProviderKind) -> OAuthPKCESession {
        ...
        if let existing = cache[config.providerId] { return existing }
